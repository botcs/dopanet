const VanillaGANDiagram = (function() {
    ...
    function constructExplanation(div) {
        const explanationData = {
            title: "How to interpret the diagram",
            steps: [
                "Contours: The decision boundary of the Discriminator (D) is represented by the contours.",
                "Arrows: The arrows represent the gradient that the Generator (G) uses to update its weights.",
                "White points: The white points represent the real data samples (X real).",
                "Orange points: The gray points represent the fake data samples (X fake) generated by the Generator.",
            ],
        };
    ...
    function constructDiagram(div) {
        ...
        const elements = {
            "X_fake": { cx: 200, cy: 300, width: 70, height: 30, label: "X fake", fill: "#E1B09E" },
            "X_real": { cx: 400, cy: 300, width: 70, height: 30, label: "X real" },
            "Generator": { cx: 200, cy: 400, width: 130, height: 30, label: "Generator (G)", fill: "#B8B8B8" },
            "Discriminator": { cx: 300, cy: 200, width: 160, height: 30, label: "Discriminator (D)", fill: "#B8B8B8" },
            "real": { cx: 350, cy: 100, width: 50, height: 30, label: "real" },
            "fake": { cx: 250, cy: 100, width: 50, height: 30, label: "fake" },
    ...
    return { constructDescription, constructDiagram, constructExplanation };
})();